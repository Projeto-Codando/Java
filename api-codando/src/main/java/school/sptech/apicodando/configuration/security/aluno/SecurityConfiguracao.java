...
//    private AutenticacaoEducadorService autenticacaoEducadorService;
    ...
    private static final AntPathRequestMatcher[] URLS_PERMITIDAS = {
            ...
            new AntPathRequestMatcher("/turmas/**", HttpMethod.POST.name()),
            new AntPathRequestMatcher("/modulos/**", HttpMethod.POST.name()),
            new AntPathRequestMatcher("/temas/**", HttpMethod.POST.name()),
            new AntPathRequestMatcher("/aulas/**", HttpMethod.POST.name()),
            new AntPathRequestMatcher("/csvFile/**"),
            new AntPathRequestMatcher("/turmas/gerarCSV/**"),
            new AntPathRequestMatcher("/turmas/presencas/**"),
